...
abstract class ApiService {
  factory ApiService(Dio dio, {String baseUrl}) = _ApiService;  /// factory constructor for ApiService make the api service singleton depend on dio object



  @POST(ApiConstants.login)  /// login api endpoint

  Future<LoginResponse> login(@Body()LoginRequestBody loginRequestBody);  /// login api request body
